...
try {
    // Get category_id for Choco-ey Series
    $category_query = "SELECT category_id FROM product_categories WHERE category_name = 'Choco-ey Series'";
    ...
    if ($category_result->num_rows > 0) {
        ...
        // Fetch products for Choco-ey Series
        ...
        if (empty($products)) {
            echo json_encode(array('message' => 'No products found for Choco-ey Series'));
        } else {
