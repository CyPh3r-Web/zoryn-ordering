...
<?php include ("../navigation/navbar.php"); ?>
    ...
    <main class="content">
        <div class="showcase">
            <h1>GOLD SERIES</h1>
            <img src="../assets/zoryn/coffee/gold_seris/gold_series.png" alt="Gold Series Drinks" class="showcase-image">
        </div>
    ...
    <script>
        ...
        function loadProducts() {
            fetch('../backend/fetch_gold_products.php')
                ...
                .then(products => {
                    ...
                    products.forEach(product => {
                        ...
                        if (!imagePath) {
                            imagePath = '../assets/zoryn/coffee/gold_seris/gold_series.png';
                        }
                        ...
                        productCard.innerHTML = `
                            <div class="product-image-container">
                                <img src="${imagePath}" 
                                     ...
                                     class="product-image"
                                     onerror="this.onerror=null; this.src='../assets/zoryn/coffee/gold_seris/gold_series.png';">
                            </div>
        ...
        document.querySelector('.next-btn').addEventListener('click', function() {
            Swal.fire({
                title: 'Continue to Coffee Series?',
                text: "Let's check out our Coffee Series menu!",
                imageUrl: '../assets/zoryn/coffee/coffeee.png', 
                imageWidth: 150, 
                imageHeight: 120, 
                ...
                if (result.isConfirmed) {
                    window.location.href = 'coffee-series.php';
                }
            });
        });
