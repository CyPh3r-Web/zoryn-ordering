...
try {
    // Get category_id for Gold Series
    $category_query = "SELECT category_id FROM product_categories WHERE category_name = 'Gold Series'";
    ...
    if ($category_result->num_rows > 0) {
        ...
        // Fetch products for Gold Series
        ...
        if (empty($products)) {
            echo json_encode(array('message' => 'No products found for Gold Series'));
        } else {
