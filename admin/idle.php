...
<script>
    ...
    let warningTimeout;
    const idleTimeout = 10000; // 10 seconds (10000 milliseconds)
    const warningTime = 15000; // 15 seconds countdown for logout
    ...
    function checkIdleTime() {
        ...
        // Show warning after 10 seconds of inactivity
        if (idleTime >= idleTimeout && document.getElementById('idleModal').style.display !== 'block') {
            showWarning();
        }
    }
    ...
    function showWarning() {
        ...
        let countdown = 15; // 15 second countdown for logout
