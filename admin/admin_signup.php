...
function sendVerificationEmail($email, $full_name, $verification_code) {
    ...
    try {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Zoryn - Admin Account Verification Code';
        $mail->Body    = "
            <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;'>
                ...
                <div style='padding: 20px; border: 1px solid #e0e0e0; border-top: none;'>
                    ...
                    <p>Hello $full_name,</p>
                    <p>Thank you for registering as an admin with Zoryn. To complete your registration, please use the verification code below:</p>
        ...
        ";
        $mail->AltBody = "Hello $full_name,\n\nYour admin account verification code is: $verification_code\n\nThis code will expire in 30 minutes.\n\nIf you did not request this verification, please ignore this email.\n\nBest regards,\nZoryn Team";
                    ...
                    if (strtotime($user['verification_expires']) < time()) {
                        ...
                        if ($stmt->execute()) {
                            ...
                            echo '<div class="success-message" style="text-align: center; padding: 20px; background-color: #d4edda; color: #155724; border-radius: 5px; margin: 20px 0;">
                                    ...
                                    <p>Your admin account has been verified and activated. You will be redirected to the login page in 3 seconds.</p>
                                    <p>If you are not redirected, <a href="admin_login.php">click here</a> to login.</p>
                                  </div>';
        ...
        <div class="signup-form">
            <?php if ($verification_sent): ?>
                ...
                <div class="login-link">
                    <p><a href="admin_signup.php">Back to Registration</a></p>
                </div>
            ...
            <?php else: ?>
                ...
                <p class="subtitle">Join Zoryn admin team</p>
