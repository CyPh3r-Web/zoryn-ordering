...
<head>
    ...
    <title>Zoryn - Choco-ey Series</title>
...
<?php include ("../navigation/navbar.php"); ?>
    <div class="tabs">
        <button class="tab active" onclick="window.location.href='choco-ey.php'">Non-Coffee</button>
        <button class="tab" onclick="window.location.href='coffee-series.php'">Coffee Series</button>
    </div>

    <main class="content">
        <div class="showcase">
            <h1>CHOCO-EY SERIES</h1>
            <img src="../assets/zoryn/choco-ey.png" alt="Choco-ey Series Drinks" class="showcase-image">
        </div>
    ...
    <script>
        ...
        function loadProducts() {
            return fetch('../backend/fetch_choco_products.php')
                ...
                .then(products => {
                    ...
                    products.forEach(product => {
                        ...
                        if (!imagePath) {
                            imagePath = '../assets/zoryn/choco_ey/choco-ey.png';
                        }
                        ...
                        productCard.innerHTML = `
                            <div class="product-image-container">
                                <img src="${imagePath}" 
                                     ...
                                     class="product-image"
                                     onerror="this.onerror=null; this.src='../assets/zoryn/choco_ey/choco-ey.png';">
                            </div>
        ...
        document.querySelector('.next-btn').addEventListener('click', function() {
            Swal.fire({
                title: 'Continue to Rookie Series?',
                text: "Let's check out our Rookie Series menu!",
                imageUrl: '../assets/zoryn/rookie_series/rookie.png', 
                imageWidth: 150, 
                imageHeight: 150, 
                ...
                if (result.isConfirmed) {
                    window.location.href = 'rookie-series.php';
                }
            });
        });
