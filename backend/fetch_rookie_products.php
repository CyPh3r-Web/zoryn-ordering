...
try {
    // Get category_id for Rookie Series
    $category_query = "SELECT category_id FROM product_categories WHERE category_name = 'Rookie Series'";
    ...
    if ($category_result->num_rows > 0) {
        ...
        // Fetch products for Rookie Series
        ...
        if (empty($products)) {
            echo json_encode(array('message' => 'No products found for Rookie Series'));
        } else {
